<?php 
            ...
            $data.="
                <tr class='align-middle'>
                    ...
                    <td>
                        ...
                        <button type='button' onclick= 'room_images($row[id], \"".addslashes($row['name'])."\")' class='btn btn-info shadow-none btn-sm' data-bs-toggle='modal' data-bs-target='#room-images'>
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            if($row['thumb']==1){
               $thumb_btn = "<i class='bi bi-check-lg text-light bg-success px-2 py-1 rounded fs-5'><i>"; 
                ...
                $thumb_btn = "<button onclick='thumb_image($row[id],$row[room_id])' class='btn btn-secondary shadow-none'><i class='bi bi-check-lg'></i></button>";
            }
            ...
            echo<<<data
                <tr class='align-middle'>
                    ...
                    <td>$thumb_btn</td>
                    <td>
                        <button onclick='del_image($row[id],$row[room_id])' class='btn btn-danger shadow-none'><i class='bi bi-trash'></i></button>
                    </td>
    ...
    if(isset($_POST['del_image'])){
        ...
        $q = "SELECT * FROM `room_images` WHERE `id`=? AND `room_id`=?";
