                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input onchange="upd_shutdown(this.checked)" type="checkbox" id="shutdown-toggle" class="form-check-input">
                            </div>
                        </div>
                ...
                <div class="modal fade" id="contacts-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="contacts_s_form">
                           <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5">Contact Details</h1>
                                </div>
                                <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    class="form-control shadow-none" required>
                                                    <small class="text-muted">Paste only the src attribute value of your Google Maps iframe embed code.</small>
